  ...
  return (
    <div className="min-h-screen font-sans selection:bg-brand-accent selection:text-brand-dark">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 flex flex-col transition-all duration-300 ${
        ...
        {/* Important Beta Notice - Glowing Cyan Design */}
        <div className="bg-brand-dark border-b border-cyan-500/20 py-2.5 px-4 relative overflow-hidden flex justify-center items-center">
             <div className="absolute inset-0 bg-cyan-500/5 animate-pulse"></div>
             <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-x-4 gap-y-1 text-[10px] md:text-[11px] font-black uppercase tracking-[0.15em] text-cyan-400/90 relative z-10 drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]">
        ...
        <div className={`w-full transition-all duration-300 ${isScrolled ? '' : 'py-4'}`}>
            ...
            <div className="flex items-center gap-4 group cursor-pointer select-none" onClick={() => window.scrollTo(0,0)}>
                ...
                {/* Blinking Beta Badge */}
                <div className="hidden md:flex items-center px-2 py-0.5 rounded-full border border-cyan-400/40 bg-cyan-900/30 animate-pulse shadow-[0_0_15px_rgba(34,211,238,0.15)]">
                   <span className="text-[10px] font-bold text-cyan-300 uppercase tracking-widest whitespace-nowrap drop-shadow-[0_0_8px_rgba(34,211,238,0.6)]">
                      Beta Version
                   </span>
                </div>
            </div>
      ...
      <section className="relative pt-44 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden lg:block h-[500px] w-full">
             ...
             {/* Floating Gold Seal Badge - 100% Ads Free */}
             <div className="absolute -top-10 -right-8 z-20 animate-bounce-slow">
                <div className="relative group cursor-default transform rotate-12 group-hover:rotate-0 transition-all duration-300">
                   
                   {/* Gold Seal Outer Ring */}
                   <div className="relative z-10 w-32 h-32 rounded-full bg-gradient-to-b from-amber-300 via-amber-500 to-amber-600 p-1.5 shadow-[0_10px_30px_rgba(0,0,0,0.3)]">
                      {/* Inner Ring (Serrated effect simulation via border) */}
                      <div className="w-full h-full rounded-full border-[2px] border-amber-200/60 bg-gradient-to-br from-yellow-100 via-amber-300 to-yellow-500 flex items-center justify-center shadow-inner relative overflow-hidden">
                          
                          {/* Shine/Gloss Effect */}
                          <div className="absolute -top-12 -left-12 w-24 h-24 bg-white/40 blur-2xl rounded-full pointer-events-none"></div>

                          {/* Content */}
                          <div className="flex flex-col items-center text-center relative z-20">
                             
                             <span className="text-4xl font-black text-amber-950 tracking-tighter leading-none drop-shadow-sm font-sans">100%</span>
                             
                             <div className="w-16 h-0.5 bg-amber-950/20 rounded-full my-1"></div>
                             
                             <span className="text-xs font-black uppercase tracking-widest text-amber-900 leading-tight">
                                ADS<br/>FREE
                             </span>
                          </div>
                      </div>
